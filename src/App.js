...
const foodMenuList = [
  // Existing 10 items
  {
    ...
    foodName: "Spaghetti",
    foodPrice: 250,
    description: "Classic Italian spaghetti with homemade tomato sauce.",
  ...
  },
  {
    ...
    foodName: "Ramen",
    foodPrice: 300,
    description: "Japanese ramen with pork broth and fresh vegetables.",
    category: "Main Course",
    imageUrl:
      "https://images.unsplash.com/photo-1591325418441-ff678baf78ef?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    isAvailable: true,
